...
// FIXME: remove module alias for models
...
app.get("/", (req, res) => res.status(OK).json({ message: "Welcome to Bevel Messaging API" }));
app.post("/", (req, res) => res.status(OK).json({ message: "Welcome to Bevel Messaging API" }));
